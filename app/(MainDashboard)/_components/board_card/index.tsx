...
const {mutate: onFavotite,pending:pendingFavorite}=useApiMutationHook(api.board.favorites);
const {mutate: onUnFavotite,pending:pendingUnFavorite}=useApiMutationHook(api.board.unfavorites);
